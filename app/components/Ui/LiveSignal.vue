...
<template>
  ...
  >
    <!--
      ...
      label is hidden. Hidden from sm: upwards because the visible
      `Koshux/Portfolio` label already supplies the context. aria-hidden
      because the surrounding role="status" already has an accessible
      name via aria-label.
    -->
    <svg
      aria-hidden="true"
      ...
      viewBox="0 0 24 24"
      fill="currentColor"
      class="h-3 w-3 shrink-0 text-paper-white/70 sm:hidden"
    >
