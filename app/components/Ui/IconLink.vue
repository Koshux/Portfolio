...
<template>
  <a
    ...
    :target="target"
    :rel="rel"
    class="inline-flex h-10 w-10 items-center justify-center rounded-full text-paper-white hover:bg-paper-white/5 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-paper-white/40 motion-safe:transition-colors"
  >
